...
<script src="<?php echo ASSETS_URL; ?>/js/businessUsuarioGrupo.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function voltar() {
        $(location).attr('href', 'usuarioGrupoFiltro.php');
    }
    ...
    function gravar() {
        ...
        gravaUsuarioGrupo(id, ativo, descricao,
            function(data) {
